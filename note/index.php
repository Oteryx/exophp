...
if ($_POST['helpers']) {
    ...
    $resultat = $obj->{$_POST['helpers']} + $obj->{$_POST['classe']} + $obj->{$_POST['note']} + $obj->{$_POST['menu']} + $obj->{$_POST['referencement']} + $obj->{$_POST['vignettes']} + $obj->{$_POST['morpion']} + $obj->{$_POST['news']} + $obj->{$_POST['csv']};
